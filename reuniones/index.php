      ...
      <!--       <a class="nav-link" href="#">Inicio <span class="sr-only">(current)</span></a> -->
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a class="dropdown-item" href="../llamadas/">llamadas teléfonicas </a>
...
<!--
    ...
    <div  class="container">
      <h1 class="page-header text-center">Reuniones</h1>
      <center><img src="./img/discusion.png" alt="imagen" style="width: 10%;"></center>
      <div class="row">
        <div class="col-sm-12">
            ...
            <tbody>
              <?php 
                ...
                try {
                  ...
                  ?>
                  <tr>
                      <td><?php echo $row['idReunion']; ?></td>
                      <td><?php echo $row['reunion']; ?></td>
                      <td><?php echo $row['lugar']; ?></td>
                      <td><?php echo $row['fecha']; ?></td>
                      <td><?php echo $row['asunto']; ?></td>
                      <td><a href="#edit_<?php echo $row['idReunion']; ?>" class="btn btn-primary btn-sm" data-toggle="modal"><span class="fa fa-edit"></span> </a> 
                      <a href="#delete_<?php echo $row['idReunion']; ?>" class="btn btn-danger btn-sm" data-toggle="modal"><span class="fa fa-trash"></span></a>  </td>
