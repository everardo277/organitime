...
<html lang="es">
  <head>
    ...
    <link rel="shortcut icon" href="./img/empresario.png" type="image/x-icon">
    ...
    <!--         <a class="nav-link" href="#">Inicio <span class="sr-only">(current)</span></a> -->
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a class="dropdown-item" href="../llamadas/">Llamadas pendientes</a>
              <a class="dropdown-item" href="../reuniones/">Reuniones</a>
              <a class="dropdown-item" href="#">Actividades pendientes</a>
            </div>
          </li>
        </ul>
<!--
    ...
    <div  class="container">
      <h1 class="page-header text-center">Actividades pendientes</h1>
      <center><img src="./img/empresario.png" alt="imagen" style="width: 10%;"></center>
      <div class="row">
        <div class="col-sm-12">
              ...
              <?php 
                ...
                try {
                  ...
                  <tr>
                      ...
                      <td><a href="#edit_<?php echo $row['id']; ?>" class="btn btn-primary btn-sm" data-toggle="modal"><span class="fa fa-edit"></span></a> 
                      <a href="#delete_<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" data-toggle="modal"><span class="fa fa-trash"></span> </a>  </td>
